  ...
  ```python
    ...
    '''
     ...
     for n in range(0, arr.shape[1], seq_length):
         ...
         yield x, y
     ```
     <b> Part 2: Building the Model-</b>  First, we're going to check if we can train using the GPU, which will make the training              process      much quicker. If you don't have a GPU, be forewarned that it will take a much longer time to train. Check out               Google Collaboratory or        other cloud computing services!
        ```python
